package com.waterfogsw.glucose.support.jwt.util

import com.auth0.jwt.JWT
import com.waterfogsw.glucose.support.jwt.error.JwtExpiredException
import com.waterfogsw.glucose.support.jwt.error.JwtVerificationException
...
class JwtTokenProviderTest : DescribeSpec({
    ...
    describe("verifyToken()") {
        context("서명되지 않은 토큰과 secret이 null이 주어지면") {
            it("토큰의 유효성을 검증한다.") {
                // arrange
                val token: String = JwtTokenProvider.createToken(
                    jwtClaims = JwtClaims {
